...
'''
code from https://github.com/airalcorn2/pytorch-geodesic-loss/blob/master/geodesic_loss.py
'''
class GeodesicLoss(nn.Module):
    ...
    def forward(self, input: Tensor, target: Tensor) -> Tensor:
        ...
        R_diffs = input @ torch.swapaxes(target, axis0=-2, axis1=-1)
